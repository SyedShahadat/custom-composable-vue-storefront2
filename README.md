...
```sh
grep -rl 'weldgalaxy' ./ | xargs sed -i '' 's/weldgalaxy/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with weldgalaxy
...
Want to contribute? Ping us on `weldgalaxy` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/weldgalaxy.git
    cd weldgalaxy
    ```
...
- [weldgalaxy integration Documentation](https://docs.vuestorefront.io/weldgalaxy)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `weldgalaxy` channel on [our Discord](discord.vuestorefront.io).
